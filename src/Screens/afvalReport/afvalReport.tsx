...
const AfvalReport = () => {
  ...
  return (
    ...
    <ReportContainer
      title="Afval rapport"
      subtitle="In dit afval rapport vindt u een overzicht van alle afvalstromen, de bijbehorende hoeveelheden afval en de gebruikte verwerkingsmethodes. Daarnaast wordt aangegeven wie het afval heeft verwerkt en welke materialen er in het afval aanwezig zijn."
    >
